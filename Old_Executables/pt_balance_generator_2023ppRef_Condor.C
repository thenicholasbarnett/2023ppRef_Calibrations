...
void pt_balance_generator_2023ppRef_Condor()
{
    ...
    TFile *fi = TFile::Open("/eos/user/n/nbarnett/PPRefZeroBias1/crab_foresting_run3_ppref_zerobias1_Data_3-14-2024_0/240314_155504/0000/HiForestMiniAOD_1.root","read");
    ...
    TFile *f1 = new TFile("pt_balance_2023ppRef_Condor_3_27_2024_0.root", "recreate");
    f1->cd();
